                            ...
                            <div className="detail-content">
                                ...
                                <div className={`detail-right ${isFixed ? 'fixed' : null} wish`}>
                                    ...
                                    <div className="hotel-day" >
                                        ...
                                        <button type='button' style={{width:'37%',marginLeft:'6px'}} className='search' onClick={()=>{setDayData([]),setSelectday([]),setDayClick(false);setListType(2);setListView(true);setDetailView(0);setSearch(false);setCal(false);window.scrollTo(0,0);}}><i className="fa-solid fa-arrow-rotate-right"></i> 초기화</button>
                                    </div>
